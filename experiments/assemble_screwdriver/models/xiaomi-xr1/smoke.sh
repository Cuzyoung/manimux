...
RUN_NAME=${XR1_RUN_NAME:-assemble-screwdriver-xr1-1xh100-offload-smoke-20260829-v2}
...
CHECKPOINT=${OUTPUT}/project_yam-xiaomi-xr1/${EXP_NAME}/last.ckpt
...
run_xr1 2>&1 | tee "${LOG}"
run_xr1 trainer.ckpt_path="${CHECKPOINT}" 2>&1 | tee -a "${LOG}"

echo "XR1_FULL_MODEL_SMOKE_AND_RELOAD_OK ${CHECKPOINT}"
