...
payload = {
    ...
    "specified_nodes": [],
    "pre_check_items": [],
    "description": "Xiaomi XR-1 screwdriver: 8 H100, global batch 64, 15000 steps, save every 1000, no resume, no W&B",
    "is_publicpath_readonly": False,
    "task_priority": 10,
    "reserve_on_fail_ms": "600000",
    "name": "xiaomi-xr1-screwdriver-8xh100-b64-15k-20260829-v2",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/models/xiaomi-xr1/train.sh",
    "framework_config": [{
