...
payload = {
    ...
    "name": "pi05-screwdriver-8xh100-b64-15k-20260829-v2",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/models/pi05/train.sh",
    "framework_config": [{
