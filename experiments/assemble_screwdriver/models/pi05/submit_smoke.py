...
payload = {
    ...
    "name": "pi05-screwdriver-1xh100-smoke-20260829-v4",
    "command": "/inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/models/pi05/smoke.sh",
    "framework_config": [
        {
