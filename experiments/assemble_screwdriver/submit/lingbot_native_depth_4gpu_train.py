...
payload = {
    ...
    "specified_nodes": [],
    "pre_check_items": [],
    "description": "LingBot-VLA2 official native-depth recipe on screwdriver: 4 H100, Muon FSDP2, global batch 32, 3000 steps, save 500, no W&B",
    "is_publicpath_readonly": False,
    "task_priority": 10,
    "reserve_on_fail_ms": "600000",
    "name": "lingbot-vla2-screwdriver-native-depth-4xh100-3k-20260829-v1",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/train/lingbot_native_depth_4gpu_train.sh",
    "framework_config": [
        {
