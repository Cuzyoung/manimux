...
payload = {
    ...
    "specified_nodes": [],
    "pre_check_items": [],
    "description": "Pi05 screwdriver: 8 H100, global batch 64, 15000 steps, save every 1000, no resume, no W&B",
    "is_publicpath_readonly": False,
    "task_priority": 10,
    "reserve_on_fail_ms": "600000",
    "name": "pi05-screwdriver-8xh100-b64-15k-20260829-v1",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/train/pi05_8gpu_15k.sh",
    "framework_config": [{
