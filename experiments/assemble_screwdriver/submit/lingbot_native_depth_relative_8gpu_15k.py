...
payload = {
    ...
    "name": "lingbot-vla2-native-depth-relative-screwdriver-8xh100-b64-15k-20260829-v1",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/train/lingbot_native_depth_relative_8gpu_15k.sh",
    "framework_config": [{
