...
payload = {
    ...
    "specified_nodes": [],
    "pre_check_items": [],
    "description": "Pi05 fair screwdriver training: 4 H100, global batch 32, 8 loader workers, 3000 steps, save every 500, W&B disabled",
    "is_publicpath_readonly": False,
    "task_priority": 10,
    "reserve_on_fail_ms": "600000",
    "name": "pi05-screwdriver-4xh100-b32-3k-20260829-v1",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/train/pi05_4gpu_fair_train.sh",
    "framework_config": [
        {
