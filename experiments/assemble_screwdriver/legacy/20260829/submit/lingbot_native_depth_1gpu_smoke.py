...
payload = {
    ...
    "specified_nodes": [],
    "pre_check_items": [],
    "description": "LingBot-VLA2 native-depth screwdriver one-H100 smoke: action, current/future depth and future-video losses, checkpoint and strict reload",
    "is_publicpath_readonly": False,
    "task_priority": 10,
    "reserve_on_fail_ms": "600000",
    "name": "lingbot-vla2-screwdriver-native-depth-1xh100-smoke-20260829-v1",
    "command": "bash /inspire/hdd2/project/liu-ming-huan/public/ziyang/manimux/experiments/assemble_screwdriver/train/lingbot_native_depth_1gpu_smoke.sh",
    "framework_config": [
        {
