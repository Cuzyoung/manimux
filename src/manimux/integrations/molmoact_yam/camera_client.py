...
if __name__ == "__main__":
    ...
    parser.add_argument("--req-hz", type=float, default=30.0, help="Polling rate when --mode=req.")
    parser.add_argument("--window", default="camera_client", help="cv2 window title.")
